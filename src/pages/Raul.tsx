...
const trophies = [
  { year: "1994–95", title: "Чемпион Испании (Ла Лига)", icon: "Trophy", category: "liga" },
...
const stats = [
  { label: "Голов за Реал", value: "323" },
  { label: "Матчей сыграно", value: "741" },
  { label: "Ассистов", value: "162" },
  { label: "Трофеев", value: "16" },
  { label: "Голов в ЛЧ", value: "71" },
    ...
    <div className="min-h-screen bg-black text-white">
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className={cn("relative z-10 text-center px-4 transition-all duration-1000 ease-out", heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12")}>
          <div className="inline-flex items-center justify-center w-28 h-28 rounded-full text-4xl font-black mb-6 border-4" style={{ background: "linear-gradient(135deg, #003087 0%, #00205B 100%)", borderColor: "#FFD700", color: "#FFD700", fontFamily: "Oswald, sans-serif" }}>7</div>
          <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tight mb-2" style={{ fontFamily: "Oswald, sans-serif", color: "#FFD700" }}>Рауль</h1>
          <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tight mb-6" style={{ fontFamily: "Oswald, sans-serif" }}>Гонсалес</h2>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-2">1994 – 2010 · Реал Мадрид</p>
          <p className="text-gray-400 text-base max-w-xl mx-auto">Капитан, символ, легенда. 16 лет преданности белому цвету — Рауль не просто играл за Реал, он был его душой.</p>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-400 mb-8">16 титулов · 1994–2010</p>
      ...
      <section className="py-20 text-center px-4" style={{ background: "linear-gradient(135deg, #00205B 0%, #003087 100%)" }}>
        <blockquote className="max-w-3xl mx-auto">
          <p className="text-2xl md:text-3xl font-light italic text-white/90 mb-6">"Когда я надеваю белую футболку — я чувствую себя непобедимым. Реал Мадрид — это моя жизнь."</p>
          <footer className="font-black uppercase tracking-widest text-lg" style={{ fontFamily: "Oswald, sans-serif", color: "#FFD700" }}>— Рауль Гонсалес</footer>
        </blockquote>
